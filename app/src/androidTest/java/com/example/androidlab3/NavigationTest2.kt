...
import com.example.androidlab3.task3.Activity1_3
...
class NavigationTest2 {
    @get:Rule
    val activityRule = ActivityScenarioRule(Activity1_3::class.java)
    ...
    fun testChangeOrientation() {
        val activityScenario = launchActivity<Activity1_3>()
